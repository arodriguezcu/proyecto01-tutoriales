...
import com.microservicios.service.InvoiceService;
...
public class InvoiceController {
  ...
  public ResponseEntity<Invoice> createInvoice(@Valid @RequestBody Invoice invoice, BindingResult result) {
    ...
    Invoice invoiceDatabase = invoiceService.createInvoice(invoice);
    
    return ResponseEntity.status( HttpStatus.CREATED).body(invoiceDatabase);
