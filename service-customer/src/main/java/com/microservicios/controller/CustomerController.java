...
import com.microservicios.service.CustomerService;
...
public class CustomerController {
  ...
  public ResponseEntity<Customer> createCustomer(@Valid @RequestBody Customer customer, BindingResult result) {
    ...
    Customer customerDatabase = customerService.createCustomer(customer);
    
    return ResponseEntity.status(HttpStatus.CREATED).body(customerDatabase);
